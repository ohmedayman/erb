...
const BUSINESS_TYPES = [
  { id: "retail", label: "بيع تجزئة", desc: "محل تجارب ببيع للزباين بالقطعة", icon: Store },
...
const FEATURES = [
  ...
  { id: "invoices", label: "الفواتير", desc: "إنشاء فواتير بيع وشراء", icon: FileText, defaultOn: true },
  ...
  { id: "expenses", label: "المصروفات", desc: "تسجيل متابعة المصروفات", icon: CircleDollarSign, defaultOn: false },
  ...
  { id: "accounting", label: "الحسابات العامة", desc: "قوائم مالية وحسابات", icon: Receipt, defaultOn: false },
  { id: "purchase_orders", label: "أوردرات الشراء", desc: "طلبات شراء من الموردين", icon: FileSignature, defaultOn: false },
...
export default function OnboardingPage() {
  ...
  const handleComplete = () => {
    ...
    userObj.storeName = prefs.storeName;
  ...
  const renderStep0 = () => (
    <div className="text-center">
      ...
      <h1 className="text-3xl font-bold text-gray-900 font-cairo mb-2">
        أهلاً بيك في StockFlow!
      </h1>
      <p className="text-gray-500 font-cairo text-lg mb-10">
        هنجّزلك النظام في دقايق
      </p>
        ...
        {[
          {
            icon: Zap,
            title: "سهل الاستخدام",
            desc: "واجهة بسيطة ومفهومة من غير تعقيد",
          },
          {
            icon: Shield,
            title: "آمن 100%",
            desc: "بياناتك محمية ومش هتطلع لأي حد",
          },
          {
            icon: Smartphone,
            title: "سريع وخفيف",
            desc: "يشتغل على الموبايل والكمبيوتر بسرعة",
          },
        ].map((item) => (
          <div
            key={item.title}
          ...
          >
            ...
            <p className="text-sm text-gray-500 font-cairo">{item.desc}</p>
          </div>
        ))}
      </div>
    </div>
  ...
  const renderStep1 = () => (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 font-cairo mb-2 text-center">
        بتشتغل في ايه؟
      </h2>
      <p className="text-gray-500 font-cairo text-center mb-8">
        اختار نوع نشاطك عشان نظبطلك النظام
      </p>
        ...
        {BUSINESS_TYPES.map((bt) => {
          ...
          return (
            ...
            >
              ...
              >
                <bt.icon
                  className={`w-6 h-6 ${selected ? "text-primary" : "text-gray-400"}`}
                />
              </div>
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 font-cairo">{bt.desc}</p>
              </div>
              {selected && (
  ...
  const renderStep2 = () => (
    <div>
      ...
      <p className="text-gray-500 font-cairo text-center mb-6">
        اختار المميزات اللي تناسبك (تقدر تغيّرها بعدين)
      </p>
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                >
                  <feat.icon
                    className={`w-5 h-5 ${on ? "text-primary" : "text-gray-400"}`}
                  />
                </div>
                {on && (
              ...
              <h3 className="font-bold font-cairo text-gray-900 text-sm mb-0.5">
                {feat.label}
              </h3>
              <p className="text-[11px] text-gray-400 font-cairo leading-tight">
                {feat.desc}
              </p>
            </button>
          );
      ...
      <div className="mt-4 text-center">
        <span className="text-sm text-gray-400 font-cairo">
          {Object.values(features).filter(Boolean).length} من {FEATURES.length} مميزة
          مفعّلة
        </span>
      </div>
    </div>
  ...
  const renderStep3 = () => (
    <div>
      ...
      <p className="text-gray-500 font-cairo text-center mb-8">
        عشان نظبطلك الصلاحيات والأدوار
      </p>
        ...
        {TEAM_SIZES.map((ts) => {
          ...
          return (
            ...
            >
              ...
              >
                <ts.icon
                  className={`w-7 h-7 ${selected ? "text-primary" : "text-gray-400"}`}
                />
              </div>
              <h3 className="font-bold font-cairo text-gray-900 mb-1">
                {ts.label}
              </h3>
              <p className="text-sm text-gray-500 font-cairo">{ts.desc}</p>
              {selected && (
  ...
  const renderStep4 = () => (
    <div>
      ...
      <p className="text-gray-500 font-cairo text-center mb-10">
        اختار الإضافات اللي تحتاجها في شغلك
      </p>
      <div className="max-w-md mx-auto space-y-4">
        <div className="flex items-center justify-between p-5 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <button
            ...
            className={`relative w-12 h-7 rounded-full transition-colors duration-200 ${
              shipping ? "bg-primary" : "bg-gray-300"
            }`}
          >
            <div
        ...
        <div className="flex items-center justify-between p-5 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <button
            ...
            className={`relative w-12 h-7 rounded-full transition-colors duration-200 ${
              installments ? "bg-primary" : "bg-gray-300"
            }`}
          >
            <div
              className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow transition-transform duration-200 ${
  ...
  const renderStep5 = () => (
    <div>
      ...
      <p className="text-gray-500 font-cairo text-center mb-10">
        ده اسم اللي هيظهر على الفواتير والتقارير
      </p>
      <div className="max-w-md mx-auto">
        <div className="relative mb-8">
          ...
          <input
            ...
            className="w-full pr-12 pl-4 py-4 text-lg font-cairo border-2 border-gray-200 rounded-xl focus:border-primary focus:outline-none transition-colors text-right bg-gray-50"
            autoFocus
          />
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 text-primary mb-2">
            ...
            <span className="font-cairo font-bold">جاهز تبدأ!</span>
          </div>
          <p className="text-sm text-gray-400 font-cairo">
            تقدر تغيّر أي حاجة من الإعدادات بعدين
          </p>
        </div>
      </div>
    </div>
  ...
  const stepLabels = [
    "ابدأ",
    businessType ? "next" : "اختار",
    Object.values(features).some(Boolean) ? "next" : "اختار",
    teamSize ? "next" : "اختار",
    "next",
    "جهّز وابدأ",
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10">
          ...
          <div className="flex justify-between items-center mt-10">
            <button
              onClick={goBack}
              disabled={step === 0}
              className={`flex items-center gap-2 px-5 py-3 rounded-xl font-cairo font-bold transition-all duration-200 ${
                step === 0
            ...
            <button
              onClick={goNext}
              disabled={!canProceed()}
              className={`flex items-center gap-2 px-8 py-3 rounded-xl font-cairo font-bold transition-all duration-200 ${
                canProceed()
        ...
        <p className="text-center text-xs text-gray-300 font-cairo mt-6">
          StockFlow - إدارة مخازن ومبيعات
        </p>
      </div>
    </div>
  );
