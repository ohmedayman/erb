  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      localStorage.setItem(
        "auth",
        JSON.stringify({ username: formData.username, loggedIn: true })
      );
      localStorage.setItem(
        "storeData",
        JSON.stringify({
              ...
              <form onSubmit={handleSignup} className="mt-8 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-border bg-white text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-lg border border-border bg-white text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm pr-12"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-primary text-white py-3 rounded-lg font-medium hover:bg-primary-hover transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/25 mt-2"
                >
                  {loading ? (
