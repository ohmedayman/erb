...
INSERT INTO subscription_plans (id, name, price, duration, features) VALUES
  ('plan-starter', 'StockFlow Starter', 3000.00, 'yearly', '["100 منتج", "50 زبون", "100 أوردر شهرياً", "فواتير وإيصالات", "تقارير أساسية", "باركود للمنتجات"]'),
  ('plan-growth', 'StockFlow Growth', 6000.00, 'yearly', '["500 منتج", "500 زبون", "1000 أوردر شهرياً", "فواتير وإيصالات", "تقارير متقدمة", "باركود", "إدارة المصروفات", "إدارة الموظفين", "المستودعات", "حركات المخزون", "إدارة الموردين", "إشعارات فورية"]'),
  ('plan-enterprise', 'StockFlow Enterprise', 9000.00, 'yearly', '["منتجات غير محدودة", "زبائن غير محدودين", "أوردرات غير محدودة", "فواتير وإيصالات", "تقارير متقدمة + PDF", "باركود", "إدارة المصروفات", "إدارة الموظفين", "المستودعات", "حركات المخزون", "إدارة الموردين", "إشعارات فورية", "الأقساط والحسابات", "تقييمات العملاء", "إدارة الفريق"]')
