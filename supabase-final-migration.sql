...
INSERT INTO subscription_plans (id, name, price, duration, features) VALUES
  ('plan-starter', 'StockFlow Starter', 3000.00, 'yearly', '["منتجات غير محدودة", "فواتير وأوردرات", "زبائن وموردين", "تقارير وتحليلات"]'),
  ('plan-growth', 'StockFlow Growth', 6000.00, 'yearly', '["منتجات غير محدودة", "فواتير وأوردرات", "زبائن وموردين", "تقارير وتحليلات", "المصروفات والقيود", "إدارة الموظفين", "المستودعات", "حركات المخزون", "إشعارات فورية", "إدارة الموردين"]'),
  ('plan-enterprise', 'StockFlow Enterprise', 9000.00, 'yearly', '["منتجات غير محدودة", "فواتير وأوردرات", "زبائن وموردين", "تقارير وتحليلات", "المصروفات والقيود", "إدارة الموظفين", "المستودعات", "حركات المخزون", "إشعارات فورية", "إدارة الموردين", "تحليلات متقدمة", "الأقساط والحسابات", "تقييمات العملاء", "إدارة الفريق"]')
